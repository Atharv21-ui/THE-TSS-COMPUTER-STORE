...
export default function Layout() {
  ...
  return (
    <div className="app-container">
      ...
      {/* Floating CTA Banner */}
      {showHeader && (
        <div className="floating-helpline-cta">
          <div className="cta-content">
            <span className="cta-pulse"></span>
            <span>📞 <strong>TSS Helpline:</strong> <a href="tel:+917317605285">+91 73176-05285</a></span>
            <span className="cta-separator">|</span>
            <span>💬 <a href="https://wa.me/917317605285" target="_blank" rel="noopener noreferrer">WhatsApp Support</a></span>
          </div>
        </div>
      )}
    </div>
