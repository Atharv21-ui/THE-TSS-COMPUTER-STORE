...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'nav.led_tv': 'LED TV & MONITORS',
    'nav.accessories': 'Accessories',
    'nav.refurbished': 'Refurbished Category',
    'nav.cart': 'Cart',
    'nav.account': 'Account',
    'nav.admin': 'Admin CMS',
    'nav.menu': 'Menu',
    ...
    // Search Bar & Modal
    'search.placeholder': 'Search THE TSS COMPUTER STORE...',
    ...
    // Home Page
    'home.badge': 'THE TSS COMPUTER STORE',
    ...
    'page.led_tv.title': 'LED TV & MONITORS',
    'page.accessories.title': 'ACCESSORIES',
    'page.refurbished.title': 'REFURBISHED CATEGORY',
    'page.warranty.title': 'STORE POLICIES & WARRANTY',
  ...
  hi: {
    ...
    'nav.led_tv': 'एलईडी टीवी और मॉनिटर',
    'nav.accessories': 'एक्सेसरीज',
    'nav.refurbished': 'रिफर्बिश्ड श्रेणी',
    'nav.cart': 'कार्ट',
    'nav.account': 'अकाउंट',
    ...
    // Search Bar & Modal
    'search.placeholder': 'THE TSS COMPUTER STORE खोजें...',
    ...
    'home.hero_desc': 'उच्च प्रदर्शन, क्वांटम वर्कलोड और इमर्सive अनुभव के लिए विशेष रूप से निर्मित।',
    ...
    'page.led_tv.title': 'एलईडी टीवी और मॉनिटर',
    'page.accessories.title': 'एक्सेसरीज',
    'page.refurbished.title': 'रिफर्बिश्ड श्रेणी',
    'page.warranty.title': 'स्टोर नीतियां और वारंटी',
