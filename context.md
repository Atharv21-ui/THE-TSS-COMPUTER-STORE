...
## Changes Made
- **TSS LOGO HOME REDIRECT & UNCONDITIONAL SCROLL SKIP**: Updated [src/components/StaggeredMenu.tsx](file:///g:/TSS/src/components/StaggeredMenu.tsx) and [src/components/Layout.tsx](file:///g:/TSS/src/components/Layout.tsx) to ensure clicking the TSS logo from anywhere on the site immediately redirects to Home (`/`), bypasses the intro scroll sequence completely, and smoothly scrolls to the top of the home page.
